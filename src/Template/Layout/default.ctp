<?= $this->element('Admin/header_default'); ?>
<header class="main-header">
    <!-- Logo -->
    <a href="<?= $base_url; ?>" class="logo">
     <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b><?= $this->Html->image('small-logo.jpg',["height"=>"35","width"=>"35"]) ?></b></span>        
      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><?= $this->Html->image('logo.png',["height"=>"40","width"=>"150"]) ?></b></span>  
    </a>
  ...
  <?= $this->element('Admin/menu_wrap_user'); ?>
...
<?= $this->element('Admin/footer_default'); ?>