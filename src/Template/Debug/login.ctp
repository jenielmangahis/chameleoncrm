<div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style="background-image:url('<?= $this->Url->build("/webroot/images/adminc/bg.jpg"); ?>')">
    <div class="pos-a centerXY">
        <div class="bgc-white bdrs-50p pos-r" style="width:141px;height:140px"><img class="pos-a centerXY" src="<?= $this->Url->build("/webroot/images/small-logo.jpg") ?>" alt=""></div>
    </div>
</div>
<div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
    ...
    <form>
        <div class="form-group">
            ...
            <input type="email" required="" class="form-control" placeholder="John Doe">
        </div>
        <div class="form-group">
