<div class="peers ai-s fxw-nw h-100vh">
  <div class="peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style='background-image: url("<?= $this->Url->build("/webroot/images/adminc/bg.jpg"); ?>")'>
    <div class="pos-a centerXY">
      <div class="bgc-white bdrs-50p pos-r" style='width: 120px; height: 120px;'>
        <img class="pos-a centerXY" src="<?= $this->Url->build("/webroot/images/adminc/logo.png"); ?>" alt="">
      </div>
    </div>
  </div>
