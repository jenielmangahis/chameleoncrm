...
Configure::write('Paypal.notify_url','http://localhost/shipping/gateway/paypal_process_ipn');
Configure::write('Paypal.cancel_return','http://localhost/shipping/gateway/paypal_process_ipn');
Configure::write('Paypal.auth_token', '');
Configure::write('Paypal.return_url','http://localhost/shipping/gateway/paypal_process_ipn');
...
function generateTransactionOrderNumber($index = 0)
{
    $order_number = 'OR' . str_pad($index, 5,"0",STR_PAD_LEFT);
    return $order_number; 
}
